...
db_sampler = dict(
    ...
    prepare=dict(
        ...
        filter_by_min_points=dict(Car=15, Pedestrian=5, Cyclist=10)),
    classes=class_names,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + "/infos_convert_v2/carla_infos_train.pkl",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file=data_root + "/infos_convert_v2/carla_infos_val.pkl",
...
vis_backends = [dict(type='WandbVisBackend',
                     ...
                     init_kwargs=dict(project='carla'))]
visualizer = dict(
