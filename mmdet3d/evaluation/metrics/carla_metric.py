...
class CarlaMetric(BaseMetric):
    ...
    def __init__(self,
                 ...
                 pcd_limit_range: List[float] = [-61.4, -10.6, -1.0, -35.4, 13.3, 3.9],
                 prefix: Optional[str] = None,
                 pklfile_prefix: Optional[str] = 'F:/mmdetection3D/mmdetection3d/result/val_result',
    ...
    def compute_metrics(self, results: List[dict]) -> Dict[str, float]:
        ...
        self.data_infos = self.convert_annos_to_carla_annos(pkl_infos)
    ...
    def convert_annos_to_carla_annos(self, data_infos: dict) -> List[dict]:
        ...
        if not self.format_only:
            ...
            for i, annos in enumerate(data_annos):
                if len(annos['instances']) == 0:
                    ...
                    # 将alpha从(n,1)维降至(n,)维
                    kitti_annos['alpha'] = kitti_annos['alpha'].reshape(-1)
                    kitti_annos['alpha'][:] = -10
